...
class InvoiceReadDetail(Base):
    ...
    Date: Mapped[str | None] = mapped_column("Date", String(80), nullable=True)
    ...
    Quantity: Mapped[str | None] = mapped_column("Quantity", String(80), nullable=True)
    Tax: Mapped[str | None] = mapped_column("Tax", Text, nullable=True)
    TaxRate: Mapped[str | None] = mapped_column("TaxRate", String(80), nullable=True)
    Unit: Mapped[str | None] = mapped_column("Unit", String(80), nullable=True)
